...
object AdeptKeys {
  ...
  val adeptTree                 = TaskKey[Either[(Set[MissingDependency], Tree), Tree]]("adept-tree", "the adept dependency tree")
  ...
  val adeptModule               = TaskKey[Module]("adept-module", "the current module")
