...
case class MissingDependency(descriptor: DependencyDescriptor, parent: Option[Coordinates], required: Boolean, override val reason: String) extends Evicted(reason)
