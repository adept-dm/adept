...
object TestData {
  ...
  val commonlib = Module(
        ...
        dependencies = Set(
            ...
            Dependency(Coordinates("excludedlib", "excludedlib", "1.0"), Hash("0c07ca0548a118c2e57308c641f7b7a3a286a9a1"), "compile->compile(*),master(*);runtime->runtime(*)"),
  ...
  val adept10 = Module(
        ...
        dependencies = Set(Dependency(Coordinates("testlib", "testlib", "4.7"), Hash("5d6b71f996d4d8fe96946df191e8151be1609984"), "test->default(*)"),
                           ...
                           Dependency(Coordinates("commonlib", "commonlib", "2.0"), Hash("815b9ad4487dd7e4e35a4fe1dc55d9bf86edcf94"), "*->default(*)", exclusionRules = Set(DependencyExclusionRule("*", "excludedlib", Coordinates("org.adept", "adept", "0.1")))),
