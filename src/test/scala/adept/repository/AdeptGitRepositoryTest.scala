...
//  
//  
//  test("Metadata rewrites") {
//    usingTmpDir { tmpDir =>
//      import adept.repository.models.VariantMetadataTestData.metadata
//
//      val adeptGitRepo = new AdeptGitRepository(tmpDir, "adept-git-rewrite")
//      val commit1 = adeptGitRepo.updateMetadata({ content =>
//        content.variantMetadata must be('empty)
//        Seq.empty
//      }, { content =>
...
//        }
//      }, { content =>
//        Seq(metadata.copy(attributes = metadata.attributes + Attribute("extra", Set("commit 2 is placed at the end"))).write(adeptGitRepo))
//      }, "updating with extra stuff")
//
...
//        }
//      }, { content =>
//        Seq(metadata.copy(attributes = metadata.attributes + Attribute("extra-extra", Set("wedged between 1 and 2"))).write(adeptGitRepo))
//      }, 
//      "updating in place with stuff",
